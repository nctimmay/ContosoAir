[![Build Status](https://dev.azure.com/nctimmay/ContosoAir/_apis/build/status/nctimmay.ContosoAir?branchName=master)](https://dev.azure.com/nctimmay/ContosoAir/_build/latest?definitionId=2&branchName=master)
